...
export default {
    methods: {
        healAi(healList,damageList,fightLength,fl) {
            ...
            if (usedAbility===0 && manaTarget/1.2 < mana && rems > 5) { //Vivify
            ...
            if (usedAbility===0 && this.character.buffs2.chiJiEnveloping>2) { //Enveloping Mist
            ...
            if (usedAbility===0  && manaTarget/1.05 < mana ) { //Refreshing Jade Wind
                usedAbility = this.heals[healList["Refreshing Jade Wind"]].healFunc(this.character, [0], 0, this.hotsData, this.injuredTargets)
            }

            if (usedAbility===0 && this.character.talents.jadeStatue===1) { //Soothing Mist
                usedAbility = this.heals[ healList["Soothing Mist"] ].healFunc(this.character, [randomTarget], 0, this.hotsData, this.injuredTargets)
            }


            if (usedAbility===0 && manaTarget < mana && rems > 4) { //Vivify
                usedAbility = this.heals[ healList["Vivify"] ].healFunc(this.character, [1], 0, this.hotsData, this.injuredTargets)
            }
            ...
            if (usedAbility===0 && this.character.buffs2.chiJiEnveloping>1 && manaTarget*1.05 < mana ) { //Enveloping Mist
                usedAbility = this.heals[ healList["Enveloping Mist"] ].healFunc(this.character, [1], 0, this.hotsData, this.injuredTargets)
            }

            if (usedAbility===0 && manaTarget*1.05 < mana && rems > 3) { //Vivify
                usedAbility = this.heals[ healList["Vivify"] ].healFunc(this.character, [1], 0, this.hotsData, this.injuredTargets)
            }

            if (usedAbility===0 && manaTarget*1.075 < mana) { //Essence Font
                usedAbility = this.heals[healList["Essence Font"]].healFunc(this.character, [0], 0, this.hotsData, this.injuredTargets)
            }


            if (usedAbility===0 && manaTarget*1.3 < mana && rems > 2) { //Vivify
                usedAbility = this.heals[ healList["Vivify"] ].healFunc(this.character, [1], 0, this.hotsData, this.injuredTargets)
            }
            ...
            if (usedAbility===0 && manaTarget*1.3 < mana && rems > 1) { //Vivify
                usedAbility = this.heals[ healList["Vivify"] ].healFunc(this.character, [1], 0, this.hotsData, this.injuredTargets)
            }
